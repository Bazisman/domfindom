...
Endpoint доступен любому активному участнику семьи, включая `viewer`, потому что он только читает данные.
...
Endpoint доступен любому активному участнику семьи. Он ничего не меняет в данных.
